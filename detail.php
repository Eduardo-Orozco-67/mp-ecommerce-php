...
$domain = 'https://eduardoorozco.000webhostapp.com/';
...
$item->description = 'Telefono Celular de Tienda EduCell';
...
$preference->external_reference = 'joseeoc6@gmail.com';
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <div class="mt-2">
                                        <a class="mercadopago-button" style="padding:12px;" href="<?php echo $preference->init_point; ?>">PAGAR</a>
                                    </div>
                                    <br><br>
                                    <a href="./" class="btn-back"><b>Regresar</b></a>
