                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18">Tienda EduCell</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                                        <div class="as-dummy-container as-dummy-img">
                                            ...
                                            <img src="./assets/galaxy-a72.jpg" class="ir ir item-image as-producttile-image  " alt="" width="345" height="345">
                                        </div>
                                        <div class="images mini-gallery gal1 ">
                                            <ul class="clearfix as-producttile-nojs">
                                                <li class="as-searchtile-nojs">
                                                    <img src="./assets/galaxy-a72.jpg" class="ir relatedlink item-image as-producttile-image" alt="" width="345" height="345" data-scale-params-2="wid=690&amp;hei=690&amp;fmt=jpeg&amp;qlt=95&amp;op_usm=0.5,0.5&amp;.v=1502831144597">
                                                </li>
                                            </ul>
                                            ...
                                            <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                                <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="2|Beats Studio3 Wireless Over‑Ear Headphones - Shadow Gray|MQUF2">
                                                    <div class="as-tilegallery-element as-image-selected">
                                                        <div class=""></div>
                                                        <img src="./assets/galaxy-a72.jpg" class="ir ir item-image as-producttile-image" alt="" data-desc="Samsung galaxy" style="content:-webkit-image-set(url(https://md6.pricebaba.com/images/product/mobile/46638/galaxy-a72.jpg">
                                                    </div>
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                            ...
                                            <div class="as-producttile-title">
                                                <h3 class="as-producttile-name">
                                                    <p class="as-producttile-tilelink">
                                                        <span data-ase-truncate="2">Samsung Galaxy A72</span>
                                                    </p>
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input type="hidden" name="img" value="./assets/galaxy-a72.jpg">
                                            <input type="hidden" name="title" value="Samsung Galaxy A72">
        ...
        <div class="as-footnotes ">
            <div class="as-footnotes-content">
                <div class="as-footnotes-sosumi">
                    Todos los derechos reservados EduCell 2021
                </div>
            </div>
        </div>
